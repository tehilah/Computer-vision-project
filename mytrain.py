# USAGE
# python mytrain.py --dataset 101_ObjectCategories
...
def save_model(save_model):
	...
	save_model.save_weights("model2.h5")
...
LABELS = set(["Blenheim_spaniel", "Lhasa", "whippet", "Doberman"])
...
print("[INFO] training network for {} epochs...".format(
	args["epochs"]))
H = model.fit_generator(aug.flow(trainX, trainY, batch_size=10),
